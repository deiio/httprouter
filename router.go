...
// Package httprouter is a trie base high performance HTTP request router.
//
...
// If a handle is registered for this path and method, the router delegates
// the request to that function.
// For the methods GET, POST, PUT and DELETE shortcut functions exist to
// register handles, for all other methods, router.Handler can be used.
//
...
//		 /blog/go/							no match
//		 /bloc/go/request-routers/comments	no match
//
...
//
// For GET, POST, PUT, PATCH or DELETE requests the respective shortcut
